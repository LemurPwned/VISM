...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(262, 574)
        self.gridLayoutWidget = QtWidgets.QWidget(Dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(40, 40, 181, 510))
