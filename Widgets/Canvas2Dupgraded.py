...
class Canvas2Dupgraded(PlotWidget, AnimatedWidget):
        def __init__(self, parent=None):
            ...
            self.plotWidget = PlotWidget(parent)
            self._i = 0
        ...
        def testInitialConditions(self):
            ...
            self.iterations = 544
            self.graphData = np.random.random(self.iterations)
        ...
        def createPlotCanvas(self):
            ...
            self.plotWidget.plot(self.graph_data, pen="r", name="data1")
            # self.plotWidget.curve.setData(graphData)
